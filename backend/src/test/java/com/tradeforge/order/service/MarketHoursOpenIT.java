...
public class MarketHoursOpenIT {
    ...
    static void marketHoursProperties(DynamicPropertyRegistry registry) {
        ...
        // Ensure now is inside [open, close]
        LocalTime openTime = now.minusHours(1);
        LocalTime closeTime = now.plusHours(1);
    ...
    void setUp() throws Exception {
        ...
        // Register user
        RegisterRequest buyerReg = new RegisterRequest("Buyer Open", "buyeropen@tradeforge.local", "Password@1234");
    ...
    @Test
    @DisplayName("Market Open: Placing order during market hours should succeed")
    void testPlaceOrderDuringMarketHoursSucceeds() throws Exception {
        ...
        assertThat(buyResponse.status()).isEqualTo(OrderStatus.ACCEPTED);
    }
}
